      ...
      <svg viewBox={`0 0 ${W} ${H}`} preserveAspectRatio="none" className="block w-full" style={{ height }} aria-hidden>
        {idle ? (
          ...
          <>
            ...
            <path d={`${d} L${W},${H} L0,${H} Z`} fill="url(#kl-speed-fill)" />
            <path
              d={d}
              fill="none"
              stroke="var(--accent)"
              ...
              vectorEffect="non-scaling-stroke"
            />
            <circle cx={last[0]} cy={last[1]} r="3" fill="var(--accent)" className="kl-live" />
          </>
        )}
      </svg>
      <span className="kl-eyebrow kl-num absolute right-0 top-0">
