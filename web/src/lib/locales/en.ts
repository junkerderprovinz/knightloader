...
export const en = {
  ...
  'settings.modules.detail.downloadclientReady': "Reachable at {path}. In Sonarr or Radarr, set URL Base to \"{urlBase}\" and the API key to one of this instance's API tokens.",
