...
export const en = {
  ...
  'settings.rules.thenHintFilter': 'A rule that rejects holds the link aside with its reason. A rule that accepts is worth having too: placed above a broad reject, with "Stop at the first matching rule" on, it is how one hoster is let through.',
  ...
  'resolver.torrent': 'Torrent and magnet',
  'accounts.routing.tip.jd': 'Fetches filehoster links without an account, with the wait and the captcha, and takes any link no other service can open.',
