...
export const en = {
  ...
  'settings.modules.detail.cnlConfigured': 'Set to listen on {address}. The start-up log says whether the port was free.',
  ...
  'accounts.routing.orderHint': 'Which service is asked first when more than one can fetch the same link. Drag a row to move it.\n\nThe order only decides between services that can take the link at all. A filehoster link never goes out as a plain download, wherever the direct link stands, since that would only save the hoster’s page.',
