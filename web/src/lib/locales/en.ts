...
export const en = {
  ...
  'settings.about.body': 'Written in evenings and weekends, on more coffee than is strictly advisable, because every other download manager wanted two clicks where one would do.',
