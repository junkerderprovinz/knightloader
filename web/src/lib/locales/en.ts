...
export const en = {
  ...
  'settings.lockHint': 'Protects this instance from anyone who can reach it – on the same network, through a domain, or through a relay. Without one, anyone who finds the address can see every download, and add, pause or delete their own.',
