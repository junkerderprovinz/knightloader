...
export const en = {
  ...
  'instances.moduleOff': 'Peer instances are switched off, so this instance neither lists nor contacts the others.',
  'instances.thisInstance': 'This instance',
  'instances.foundTitle': 'Found on your network',
  'instances.foundHint': 'KnightLoader instances announcing themselves on this network. Nothing is connected until you add one, and adding one only stores its address. Being on the same network does not count as permission. An instance with a password set also needs a pairing code before it will accept anything.',
  ...
  'settings.preParserHint':
    'Finds links anywhere in what you paste or drop, not only one clean URL per line. It rejoins a link that a mail client wrapped across a line break, and also reads a bare host and path with no http:// in front as a link. Off takes each line exactly as typed, the way this always worked before.',
  ...
  'settings.shape.slightlyRounded': 'Soft',
  ...
  'settings.navLabels.titleHint': 'How much of each entry is drawn: the sidebar, the settings column, the lists\' toolbars and the collector\'s own buttons. On hover the tile keeps its size and the name appears under the pointer.',
  ...
  'cleanup.what.offline': 'Every link on this instance whose host answered that it is gone. Links nobody could check are left alone.',
  ...
  'cleanup.finishedKeepsFiles': 'Finished downloads are only taken off the list. This entry never deletes anything on disk.',
  ...
  'settings.nav.collector': 'Link collector',
  'settings.nav.downloads': 'Downloads',
  'settings.nav.archives': 'Archives',
  'settings.nav.rules': 'Rules & categories',
  ...
  'settings.downloads.autoConfirmOff': '"Start added links immediately" is switched off under Link intake above, so no countdown runs here.',
  ...
  'settings.module.keepawake': 'Keep the computer awake while downloading',
  ...
  'settings.downloads.idleActionHint': 'What happens once nothing is left running, queued or waiting to start. A link you have switched off never counts as work left to do, so it cannot hold this off forever. A manually paused or held link still counts: both mean "wait a bit", not "never".',
  ...
  'settings.modules.alsoOn': 'Also on the {page} page',
  'settings.modules.detail.cnlListening': 'Listening on {address}',
  'settings.modules.detail.cnlOff': 'Switched off',
  'settings.modules.detail.cnlOffByEnv': 'Switched off with KL_CNL=0',
  'settings.modules.detail.cnlUnavailable': 'Could not open {address}. Usually a running JDownloader already holds the port.',
  'settings.modules.detail.extractionOff': 'Off. An extraction already under way finishes.',
  'settings.modules.detail.extractionKeep': 'Archives are kept after extraction.',
  ...
  'settings.modules.detail.targetsSending': '{n} targets sending',
  'settings.modules.detail.targetsSendingOne': '1 target sending',
  ...
  'settings.modules.detail.windows': '{n} time windows',
  'settings.modules.detail.windowsOne': '1 time window',
  'settings.modules.detail.reconnectMethod': 'Method: {method}',
  'settings.modules.detail.packagizerOff': 'Off. New links are not sorted by the rules.',
  'settings.modules.detail.linkfilterOff': 'Off. Every link is taken in.',
  'settings.modules.detail.rules': '{n} rules',
  'settings.modules.detail.rulesOne': '1 rule',
  'settings.modules.detail.connectionsOff': "Off. New downloads go out over this machine's own address.",
  'settings.modules.detail.connectionsInUse': '{n} connections in use',
  'settings.modules.detail.connectionsInUseOne': '1 connection in use',
  'settings.modules.detail.federationOff': 'Off. Peer instances stay saved, but this instance neither lists nor contacts them.',
  'settings.modules.detail.peers': '{n} peer instances',
  'settings.modules.detail.peersOne': '1 peer instance',
  'settings.modules.detail.jdMissing': 'Encrypted containers are refused, and hoster links go to a debrid service or fail.',
  'settings.modules.detail.jdOff': 'Off. Downloads already in JDownloader finish, and new hoster links wait until it is back on.',
  'settings.modules.detail.jdReachable': 'Reachable. Encrypted containers can be opened.',
  'settings.modules.detail.ytdlpNotFound': "yt-dlp was not found (a copy fetched on the Resolvers page, KL_YTDLP, or \"yt-dlp\" on PATH). Media pages fail with the site's own error instead.",
  'settings.modules.detail.ytdlpOff': 'Off. A running download finishes, and video links wait until it is back on.',
  ...
  'settings.modules.detail.scriptsEnabledOne': '1 script switched on',
  'settings.modules.reason.cnlSwitch': 'Listens on 127.0.0.1:9666 unless KL_CNL names another port. Switching it off here leaves KL_CNL as it is, so after a restart the port opens the way the environment says.',
  'settings.modules.reason.cnlNoListener': "This process opens no Click'n'Load port.",
  'settings.modules.reason.jdNotConfigured': 'No JDownloader backend is configured. Set KL_JD to a JDownloader this instance can reach, then restart.',
  'settings.modules.reason.ytdlpMissing': 'No yt-dlp was found. Fetch one on the Resolvers page, or set KL_YTDLP.',
  'settings.modules.reason.captchaNoJD': 'Captchas come only from the JDownloader backend, and none is configured (KL_JD).',
  ...
  'settings.linkIntake.cnlHint': "Takes the links a website's Click'n'Load button sends, just like JDownloader. What you switch here lasts until the next restart, then KL_CNL decides again.",
  'settings.linkIntake.watchParked': 'Switching it on again restores the folder it watched before.',
  'settings.linkIntake.watchPickFolder': 'Choose a folder below and the switch turns on by itself.',
  ...
  'settings.rules.stopHint': 'When off, every matching rule contributes and a later rule wins per field, which is what the Packagizer wants. When on, evaluation ends at the first match, which is what a filter usually wants: an accept placed above a broad reject then actually protects the link.',
  ...
  'settings.rules.ifHint': 'Every condition has to hold. An either/or is written as two rules, which keeps the list readable top to bottom. A rule with no conditions matches every link. That is how a catch-all folder or a blanket reject at the end is written.',
  ...
  'settings.rules.noConditions': 'No conditions, so this rule matches every link.',
  ...
  'settings.rules.sizeHint': 'A plain number is bytes. Units work too (700 MB, 1.5 GiB), and both are read as 1024-based, the same as every size the rest of the app prints.',
  'settings.rules.badSize': 'This is not a size.',
  'settings.rules.pattern': 'Pattern',
  'settings.rules.patternHint': 'A Go regular expression, unanchored. This is the only operator that does not ignore case; put (?i) at the front if you want it to. An unparsable pattern is refused with the reason rather than quietly matching nothing.',
  'settings.rules.category': 'File type',
  'settings.rules.categoryCustom': 'Custom pattern',
  'settings.rules.categoryHint': 'A shortcut that fills in the pattern for a whole family of extensions. It is stored as an ordinary pattern, so you can pick one and then edit it. After that, this goes back to "Custom pattern", because the shortcut no longer says what the rule does.',
  ...
  'settings.rules.testPackageHint': 'The package the link would arrive in, before any rule runs. It is what <jd:packagename> resolves to, because a folder template does not see the package name a rule sets in the same pass.',
  ...
  'settings.rules.folderFromSettingsHint': 'No rule named a folder, so the link lands in the configured download folder, possibly inside a per-package subfolder if that setting is on. This page does not guess the full path. All it can say for certain is that no rule changed it.',
  ...
  'settings.reconnect.upnpState':
    'Nothing else is needed. The gateway is found by asking the network, so this is the method that works without knowing anything about the router.',
  ...
  'settings.reconnect.runNow': 'Reconnect now',
  ...
  'strip.of': 'of',
  'strip.hint':
    'Bytes fetched against bytes owed. Finished, failed and collected links stay out of the total, and so does anything whose size the host has not stated yet, because a guess there would be a number nobody can act on.',
  ...
  'folders.newFolderHint': 'Creates an empty folder inside the one listed above, on the machine KnightLoader runs on.',
  'folders.newName': 'Name of the new folder',
  'folders.create': 'Create',
  'folders.error.exists': 'There is already something called “{name}” here.',
  'folders.error.denied': 'KnightLoader may not write here. Check who owns this folder and its permissions.',
  'folders.error.outside': 'This folder is outside the roots this instance may use.',
  'folders.error.missing': 'This folder is gone. Go up a level and try again.',
  'folders.error.separator': 'A name cannot contain / or \\. Create one level at a time.',
  'folders.error.dots': '“.” and “..” cannot be folder names.',
  'folders.error.character': 'A name cannot contain < > : " | ? * or control characters.',
  ...
  'accounts.addAccountTitle': 'Add your {service} account',
  'accounts.noServicesFound': 'No services match your search.',
  'accounts.passwordField': 'Password',
  'accounts.pickDebridAccount': 'Choose a debrid account',
  ...
  'accounts.field.apiUser': 'API username',
  'accounts.field.apiKey': 'API key',
  'accounts.field.customerId': 'Customer ID',
  'accounts.field.email': 'Email address',
  ...
  'resolver.direct': 'Direct download',
  'resolver.http': 'Plain HTTP fallback',
  ...
  'collector.linkPasswordHint':
    'The password the hoster’s own page asks for before it hands over the file. The archive password above is a different one.',
  ...
  'settings.schedule.empty': 'No schedules yet',
  'settings.schedule.emptyHint':
    'Nothing pauses or limits the queue by the clock. Create a schedule to hold downloads overnight or to cap the speed while you use the connection yourself.',
  'settings.schedule.use': 'Use this schedule',
  'settings.schedule.moveUp': 'Move up',
  'settings.schedule.moveDown': 'Move down',
  'settings.schedule.remove': 'Remove this schedule',
  'settings.schedule.edit': 'Edit this schedule',
  ...
  'settings.schedule.daysHint':
    'The weekdays this schedule starts on. For one that runs past midnight, tick the day it starts: "Fri 22:00-06:00" ends Saturday morning without Saturday being ticked.',
  ...
  'settings.schedule.endHint':
    'An end time before the start time means the schedule runs past midnight and ends the next morning. An end time equal to the start time is refused, because it could mean a whole day or no time at all.',
  ...
  'settings.schedule.disabledOff': 'This schedule is switched off and never runs. The queue behaves as if it were not here.',
  ...
  'settings.schedule.stateNow.paused': 'A schedule is pausing the queue right now.',
  'settings.schedule.stateNow.limited': 'A schedule is capping the queue at {rate} right now.',
  'settings.schedule.stateNow.running': 'No schedule is in force right now.',
  'settings.schedule.nextChange': 'Next change: {when}',
  'settings.schedule.noNextChange': 'As they are set up, none of the schedules will ever change the queue.',
  'settings.schedule.stateNow.suspendedUntil': 'The schedules are suspended until {when}.',
  'settings.schedule.stateNow.suspendedOpen': 'The schedules are suspended until you switch them back on.',
  'settings.schedule.suspend': 'Suspend schedules',
  'settings.schedule.suspendHint':
    'Sets every schedule aside for a while without changing any of them. Meanwhile the queue runs on your own settings, and once the time is up the schedules apply again by themselves. A restart does not end the suspension.',
  'settings.schedule.suspend.off': 'Not suspended',
  'settings.schedule.suspend.hour': 'For an hour',
  'settings.schedule.suspend.threeHours': 'For three hours',
  'settings.schedule.suspend.midnight': 'Until midnight',
  ...
  'settings.help.intake.body':
    'Paste links into the Collector, one per line or as messy text. A scan finds links wherever they sit: inside a sentence, several to a line, or wrapped across two lines by a mail client.',
  ...
  'settings.help.collector.link': 'Open Link collector settings',

  'settings.help.rules.title': 'Rules: packages, folders and what gets kept',
  'settings.help.rules.body':
    'The Packagizer renames a link, chooses its folder and sets its download options as it arrives, from conditions you write. The Link Filter decides whether a link is kept at all. A rejection always names the rule that caused it and why.',
  'settings.help.rules.link': 'Open Rules',

  'settings.help.queue.title': 'Managing the queue',
  'settings.help.queue.body':
    'Pause, resume or reorder any link, alone or as a whole package. There are two ways to stop the queue. Halting it leaves anything already running untouched, so it finishes on its own. Stopping every transfer right now first shows what would be lost and only goes ahead once you confirm. The warning is there for transfers that cannot resume where they left off.',
  ...
  'settings.help.limits.b2':
    'Reconnect: ask the router for a new public address, the only thing that lifts a limit keyed to the address itself. This works through UPnP, an external program, a script, or by replaying HTTP requests against the router’s admin page. Existing JDownloader LiveHeader/curl scripts work unchanged.',
  ...
  'settings.help.limits.link1': 'Open Network',
  ...
  'settings.help.after.body':
    'Archives are extracted automatically: zip (including encrypted, both WinZip AES and the legacy ZipCrypto), rar with multi-volume sets, 7z, tar, and gzip/bzip2/xz/zstd whether or not they wrap a tar. Extraction is pure Go and needs no external unrar or 7z binary. A list of passwords is tried in order for an encrypted archive. A finished file is checked against whatever checksum shipped with it: an .sfv listing, an md5/sha1/sha256sum file, or a CRC32 the release name itself carries.',
  ...
  'settings.help.schedule.body':
    'A weekly timetable pauses or throttles the queue by the clock, for example in a nightly window, and stays correct across the daylight-saving change. It is the same idea as JDownloader’s Scheduler.',
  'settings.help.schedule.link': 'Open Automation',
  ...
  'settings.help.advanced.body':
    'Every setting this build has can be read and changed by its raw name on the Advanced page. That includes a few that have no dedicated control anywhere else yet, such as how a mirror of an already-downloaded file is treated and what happens when a download would land on a name already taken.',
  ...
  'settings.about.donateAppeal': 'Toss a coin to your knight: it covers part of the costs and keeps the project alive. Everything I build costs nothing and shows no ads.',
  'settings.about.cryptoIntro': 'Pick a currency and a network, then scan the code or copy the address.',
  ...
  'settings.scripts.emptyHint':
    'A script runs your own JavaScript when something happens, such as a download finishing, a download failing or the queue going idle. You can also run it on demand, from “Test run” here or from the “Run script” entry in the download list’s right-click menu. Add one to get started.',
  'settings.scripts.loadFailed':
    'Scripts could not be loaded. If this build does not include the automation engine yet, this page has nothing to show. Try again once it does.',
  ...
  'settings.scripts.triggerHint':
    'What starts this script. With Manual, it runs only when you ask for it: from “Test run” below, or from the “Run script” entry in the download list’s right-click menu.',
  ...
  'settings.access.relay.seesAddress': 'The project relay runs at {address}.',
  ...
  'settings.access.ownRelay.containerHint': 'If none of your instances is reachable from outside, the relay has to live somewhere else, on your server or a small VPS. Install the container from the Unraid Community Applications, or with the command below.\n\nThe container needs no setup: start it, enter its address above, done. It stores nothing, so there is nothing to back up.',
  ...
  'settings.access.tokens.rightsHint':
    'What an app with this token may do. Full access can do everything, including settings and the password. Add and read is enough for Sonarr and Radarr. When they clear a finished download, it stays in your list unless the token also has Control. Read only sees your downloads and changes nothing.',
  ...
  'settings.browsertools.sourceCode': 'Source code',
  ...
  'settings.system.lifecycleNoteContainer': 'This is a container build. Quit and Restart do the same thing here: whether the process comes back is decided entirely by your container\'s own restart policy.',
  ...
  'settings.torrents.portMapNeedsPort':
    'Set a port above before mapping it. With 0 there is nothing for the router to forward to.',
  ...
  'settings.torrents.portMapUnconfirmed':
    'The router accepted the request, but the mapping could not be confirmed as working. Some routers accept the request silently without applying it. Try a connectivity check from outside the network.',
  ...
  'onboarding.welcome.body':
    'KnightLoader is a self-hosted download manager. Paste or drop a link and the matching backend fetches it: the built-in engine for plain file links, yt-dlp for media pages, a debrid service for hosters you already pay for, or a headless JDownloader for everything else. This short tour covers the one setting worth checking before you start.',
  ...
  'onboarding.accounts.body':
    'The queue works with no account at all. When you do want full speed on a hoster or debrid service you already pay for, add its login under Accounts. None of this needs to be set up now.',
  ...
  'settings.hostRules.retryMaxHint': 'The doubling stops here. 0 hands the question on the same way the wait above does and ends at the built-in 10 minutes. A ceiling below the first wait is not used as you typed it: the app quietly raises it to that wait, because otherwise the number you entered as the wait would never once be the wait. Your value stays in the box either way, so a 60 here beside a 3600 above keeps reading 60 and behaves as 3600.',
  'settings.hostRules.retryTries': 'Attempts for this hoster (0 = global setting)',
  'settings.hostRules.retryTriesHint': 'How many times a failed download from this hoster is tried at all. 0 does not mean "never": it hands the question on to the rule for that kind of failure and then to "Automatic retries" on the Downloads page. Use it to give one flaky hoster ten attempts without raising the count for everything else. No row may ask for more than 20, the same ceiling the global number has.',
  ...
  'settings.advanced.onOfflineHint': 'What happens to a link a check has already found gone, at the moment a batch leaves the collector. "Add it anyway" starts it as if nothing had matched, and it is the only answer that can never lose a link over a signal that was wrong. "Leave it in the collector", the default, changes nothing else about the link, so confirming again later with a different answer still reaches it. "Throw it away" is the only answer here that deletes anything. "Ask me" only actually asks when you are confirming by hand: auto-confirm, the watch folder and Click\'n\'Load have nobody there to answer, so for them it falls back to leaving the link in the collector. A single batch can carry its own answer and override this one.',
  ...
  'settings.downloads.autoConfirmDelayHint': 'How long a new batch waits in the collector before it confirms itself. That is your chance to look it over, throw a link out or change the folder. Each batch counts down on its own at the top right, and the stop button there leaves its links in the collector. Links you confirm or remove in the meantime are left alone. 0 confirms a batch the moment it arrives. A new value also applies to countdowns that are already running, so setting 0 confirms them at once. None of this happens unless "Start added links immediately" is on, under Link intake above, and switching that off stops every countdown. One day is the ceiling: a countdown is meant to be watched while it runs, and anything longer is a stray digit rather than a preference. A negative number becomes 0 when you save.',
  'settings.downloads.onDupes': 'Links you already have',
  'settings.downloads.onDupesHint': 'What happens to a link leaving the collector that is already in your list. "Add it anyway" treats it like any other link. "Leave it in the collector" does not confirm it and changes nothing else about it, so confirming again later still picks it up. "Throw it away" takes it out of the list and is the only answer that discards anything, which is why it is never the default. "Ask me" only asks when a person actually pressed Confirm: the countdown, the watch folder and Click’n’Load have nobody to ask, so for those it falls back to leaving the link in the collector. A single batch can override this; what you set here is what applies when it does not.',
  'settings.downloads.addAtTop': 'Put newly confirmed links at the front of the queue',
  'settings.downloads.addAtTopHint': 'A batch leaving the collector plays next instead of queueing behind everything that was already waiting. It moves inside its own priority band, exactly where "Move to top" would put it, so a download you gave a higher priority still runs first. Off is how it ships, and then links join the back of the queue. It applies however the batch was confirmed: by hand, by the countdown, or out of the watch folder.',
  ...
  'settings.resolvers.measureHint': 'Reads every finished video or audio download back with ffprobe and records what is really in it: runtime, resolution, codecs, how many audio tracks. It runs one short local process per download, with no network access and no new dependency. What it catches is a download that stopped early and got muxed anyway, where the exit code is 0 and the size looks plausible and the picture stops twenty minutes in. What it cannot catch is a merge killed mid-write, which keeps the intended runtime in its header, and that case normally fails loudly on its own anyway.',
  'settings.resolvers.measureShortPercent': 'Counts as short below (percent)',
  'settings.resolvers.measureShortPercentHint': 'How much of the runtime the source announced the file has to actually contain before it stops counting as short, in percent. 90 is the default, not 99: a real download often lands a little under the announced number, and a threshold that fires on those teaches everybody to ignore it. A truncated merge is off by half, not by five percent. Anything outside 1 to 100 is stored as 90 rather than being pinned to the nearest end. There is no 0 for "never complain", because being told is why you switch the check on.',
  ...
  'settings.resolvers.liveMaxMinutesHint': 'Stops a recording after this many minutes, counted from the first moment stream data actually arrives rather than from when the task started, so waiting for a premiere or fighting an anti-bot check does not eat into it. 0 means no limit. The limit is a duration, not a time of day: "stop at 23:00" on a stream started at 22:00 is a one-hour cap that silently becomes twenty-three hours when the same link is pasted at midnight. Reaching the limit stops the recording gently, so the file is finalised and plays, and the row settles as done with the reason on it rather than as an error.',
  ...
  'settings.hostRules.emptyHint': 'Until you add one, everything follows the values on the Downloads page.',
  ...
  'settings.feeds.testMatchNo': 'Left out',
  ...
  'settings.rules.action.categoryHint': 'Files matching links in one of the drawers from the Categories list further down this page, which brings its own folder, queue position, unpacking switch and collision rule with it. Left unchanged, no rule has an opinion and the link stays unfiled. If this rule also names a download folder, that folder wins and the drawer still supplies everything else. Naming a drawer that has been deleted is refused when you save, because a rule pointing at a drawer that is not there does nothing at all on every link it matches, silently.',
  'settings.rules.action.categoryNone': 'No categories yet. Create one under Categories further down this page first, otherwise this rule would file links in a drawer that does not exist.',
  ...
  'volume.meter': 'Volume',
  'volume.meterHint': 'What has finished downloading since the counter last restarted, measured against the cap on the Downloads settings page. The number moves when a download finishes, not while one is running. It is added up out of the download history, so emptying that history sets this counter back to zero as well.',
  'task.waiting.volumeCap': 'Waiting for the volume cap',
  'task.waiting.module': 'Module switched off',
  ...
  'settings.dbmaint.checkFailedHelp': 'Do not restart the server. It refuses to start at all on a database it cannot open, and a container set to restart by itself will then keep looping. Try the Download backup button under Backup & transfer on the General page first and put the file somewhere safe; on a badly damaged database that can fail too. If it does, stop the server and copy {path} aside by hand before anything else touches it, then bring your last good backup back in with Upload backup.',
  ...
  'settings.downloads.idleQuitHint': 'Quitting drains whatever is still in flight and stops the process, exactly like the Quit button on the General page. Whether it starts again afterwards is your container\'s restart policy, not this setting.',
  ...
  'settings.transfer.cardTitle': 'Backup & transfer',
  'settings.transfer.cardHint': 'Both files are written here and saved by your browser, and they go nowhere else. Neither of them carries your debrid and hoster logins, the header profiles, the captcha keys, the login password for this interface or your scripts: those sit sealed outside settings.json, and the archive leaves them behind too, so you set them up again on the new box.',
  'settings.transfer.archiveLabel': 'The whole install',
  'settings.transfer.archiveText': 'One archive with everything this box holds: the database, the download list, the history and the settings, passwords included, so keep the file private. Restoring replaces all of it and takes effect at the next start.',
  'settings.transfer.settingsLabel': 'Settings only',
  'settings.transfer.settingsText': 'Only settings.json: the queue limits, the folders, the rules, the categories and the timetable. Importing shows you every key first, writes only what you tick and applies straight away, with no restart.',
  ...
  'settings.mediahook.nameHint': 'The name you pick this address by on a drawer under Rules & categories. Letters, digits and - _ or . only. It cannot be changed afterwards, because a drawer points at it by this name.',
  ...
  'settings.health.oldHealthHint': 'The old address /api/health has not changed and still answers "ok" for as long as this process is up, whatever this page says. It stays that way because the container\'s own health check, the Click\'n\'Load bridge and the phone app\'s search for instances on your network all read it, and an answer other than "ok" there would mark the container unhealthy and make the phone stop finding this instance. This page is where a fault is reported; that address only says whether anything is listening.',
  ...
  'settings.diagnostics.fileKeepHint': 'How many renamed files stay beside the one being written. Zero keeps only the current file; it does not switch the log off.',
  ...
  'settings.selftest.torrentPort.notCheckedAdvice': 'Only a machine outside your own network can answer that, and this app contacts none you did not pick yourself. The UPnP button on the Torrents page asks your router to forward the port and tells you whether it could confirm it. A port saved after this run\'s first torrent only takes effect after a restart.',
  ...
  'settings.diagnostics.startupHint': 'What this instance checked once when it started: the programs it calls out to, every folder a download can land in, and the clock a schedule is read against. It is a reading, so nothing here holds a download back or stops the server coming up. The start only looks; the write test happens when you press Check again.',
  ...
  'settings.diagnostics.fix.missing': 'The folder is not there. The nearest one above it that does exist is {measured}. On a box that mounts a share this usually means the share is not mounted, and that is why this check does not create the folder: a folder made underneath a missing mount takes the downloads instead, and they are gone with the next container update.',
  ...
  'settings.diagnostics.fix.tzUnset': 'TZ is not set and no local time was found, so this instance runs on UTC. That works, but a schedule window written as 23:00 then means 23:00 UTC, not 23:00 where you are.',
  ...
  'auth.twoFactor.needsPassword': 'Set a password first. A second factor guards a password, so there has to be one.',
  'auth.twoFactor.beforeYouStart': 'Setting this up ends with eight recovery codes, shown once and never again. Have somewhere to write them down before you start.',
  'auth.twoFactor.enable': 'Set up',
  'auth.twoFactor.scan': 'Scan this with your authenticator app.',
  'auth.twoFactor.qrLabel': 'QR code that adds this instance to an authenticator app',
  'auth.twoFactor.secretManual': 'Or type this in by hand',
  'auth.twoFactor.confirmLabel': 'Six-digit code from the app',
  'auth.twoFactor.confirm': 'Turn on',
  'auth.twoFactor.codesTitle': 'Write these down now',
  'auth.twoFactor.codesHint': 'This is the only time they are shown. Each one works once, in place of a code from the app, and they are all that gets you back in if the phone is lost.',
  'auth.twoFactor.codesAck': 'I have written them down',
  'auth.twoFactor.recoveryLeft': '{n} recovery codes left.',
  'auth.twoFactor.disable': 'Turn off',
  'auth.twoFactor.disablePrompt': 'Enter a code to turn it off',
  'auth.twoFactor.signInHint': 'Enter the code from your authenticator app, or one of your recovery codes.',
  'auth.twoFactor.verify': 'Continue',
  'auth.twoFactor.codeWrong': 'That code was not accepted.',
  'auth.passkey.title': 'Passkeys',
  'auth.passkey.hint': 'A key held by your phone, laptop or security stick signs you in without typing the password. It is an extra way in: the password keeps working, and removing every passkey locks nobody out. A passkey belongs to the web address it was created on, so one registered through a proxy does not work over the LAN address, and the other way round.',
  'auth.passkey.registered': '{n} registered',
  'auth.passkey.none': 'None registered',
  'auth.passkey.needsPassword': 'Set a password first. A passkey is a second way into a login, so there has to be a login.',
  'auth.passkey.unavailableTitle': 'Passkeys need a host name, and this page is open on an IP address.',
  'auth.passkey.unavailableReason': 'A passkey is tied to a domain, so browsers refuse the whole exchange on a bare address, and refuse it again on a certificate they do not trust. Reach KnightLoader through a reverse proxy under a real name with a valid certificate, open it there, and register the key on that address.',
  'auth.passkey.noBrowserTitle': 'This browser does not offer passkeys.',
  'auth.passkey.noBrowserReason': 'Nothing is wrong with this instance. Open it in a current browser, or on a device that can hold a passkey, and the button appears here.',
  'auth.passkey.add': 'Set up',
  'auth.passkey.create': 'Create',
  'auth.passkey.nameLabel': 'Name',
  'auth.passkey.nameHint': 'Yours to pick, so you can tell your keys apart later. It means nothing to the browser.',
  'auth.passkey.namePlaceholder': 'e.g. my phone',
  'auth.passkey.defaultName': 'Passkey',
  'auth.passkey.usableHere': 'Works on this address',
  'auth.passkey.otherAddress': 'Registered for {host}',
  'auth.passkey.notSynced': 'not synced to a keychain',
  'auth.passkey.lastUsed': 'last used {when}',
  'auth.passkey.rename': 'Rename',
  'auth.passkey.saveName': 'Save',
  'auth.passkey.remove': 'Remove',
  'auth.passkey.removeTitle': 'Remove this passkey?',
  'auth.passkey.removeBody': '{name} will no longer sign you in. The password still works.',
