...
export const en = {
  ...
  'settings.about.body': 'A campaign fought in a single suit of armour: free, open-source tools that did not exist in this shape. No accounts, no telemetry, and nothing readable ever leaves your own walls. Forged on evenings and weekends with a lot of heart, because waiting was not an option.',
  ...
  'settings.access.relay.body': 'The detour for instances on different networks. On one network you do not need it.',
  ...
  'settings.access.relay.seesTip': 'Not visible: what you download, your list, your files and your access token. All of it is encrypted, and the key stays with you.\n\nVisible: that your instances are connected, which IP addresses they dial from, and when they send something.\n\nNo encryption removes that. If it bothers you, use your own relay.',
  'settings.access.relay.offNote': 'No relay active. On one network your instances still find each other by themselves. Across different networks they cannot reach each other.',
  'settings.access.relay.none': 'No relay',
  'settings.access.relay.noneHint': 'This instance uses no relay. On one network your instances still find each other.',
  ...
  'settings.access.ownRelay.body': 'For running the meeting point yourself.',
  ...
  'settings.access.ownRelay.serveHint': 'Needs no second container. Only works if this instance is reachable from outside.',
  ...
  'settings.access.ownRelay.containerHint': 'For when none of your machines is reachable from outside. The relay then has to live somewhere else, a small VPS for instance.\n\nThe container stores nothing. There is nothing to back up.',
