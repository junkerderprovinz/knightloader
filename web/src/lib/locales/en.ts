...
export const en = {
  ...
  'settings.access.remote.pairPrereq': 'For this to work from outside your own network - say, pairing with a phone away from home - this instance needs a domain behind a reverse proxy, or a VPN, set up first. A LAN-only address only pairs with another instance on the same network.',
