...
> self-hosted KnightLoader download manager. Setup takes one connection phrase
> and no account. Messages to your instances are end-to-end encrypted.
...
>   codes, locally; nothing is fetched or sent.
