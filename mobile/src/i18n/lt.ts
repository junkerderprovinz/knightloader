...
export const lt: Dict = {
  ...
  'settings.aboutBody': 'Vienas riteris, vienas žygis: laisvi, atvirojo kodo įrankiai, kokių tokių nebuvo. Jokių paskyrų, jokios telemetrijos, ir niekas skaitomo niekada nepalieka tavo paties sienų. Kalta vakarais ir savaitgaliais iš širdies, nes laukti nebuvo išeitis.',
  'settings.accentReset': 'Numatytoji',
  'settings.aboutCoffeeButton': 'Pavaišinti kava',
  'settings.aboutCoffee': 'KnightLoader yra nemokamas ir toks liks. Auka palaiko projektą gyvą ir padengia jo išlaidas: domeną, serverį ir vakarus, kurie į jį sudedami.',
