...
export const lt: Dict = {
  ...
  'downloads.startHeld': '{n} nuorodų atmesta, jos nepaleistos.',
  ...
  'captcha.solverWaitingHint': 'Tu žiūri, todėl sprendėjai pirmiausia laukia tavo atsakymo. Kai tik programėlė atsiduria fone arba baigiasi laikas, perima pirmasis sprendėjas tavo tvarkoje.',
