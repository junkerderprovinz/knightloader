...
export const ro: Dict = {
  ...
  'settings.aboutBody': 'Scris seara și în weekenduri, cu mai multă cafea decât e recomandabil, pentru că orice alt manager de descărcări voia două clicuri unde ajungea unul.',
