...
export const ro: Dict = {
  ...
  'settings.aboutBody': 'Un singur cavaler, o cruciadă: unelte libere, open source, care nu existau așa. Fără conturi, fără telemetrie și nimic lizibil nu îți părăsește vreodată zidurile. Făurit seara și în weekend cu multă inimă, pentru că așteptarea nu era o opțiune.',
  'settings.accentReset': 'Implicit',
  'settings.aboutCoffeeButton': 'Fă-mi cinste cu o cafea',
  'settings.aboutCoffee': 'KnightLoader este gratuit și rămâne așa. O donație ține proiectul în viață și acoperă ce costă: domeniul, serverul și serile care intră în el.',
