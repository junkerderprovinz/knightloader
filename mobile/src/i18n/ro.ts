...
export const ro: Dict = {
  ...
  'settings.aboutBody': 'Scris seara și în weekend, de o singură persoană, pentru că orice alt manager de descărcări cerea două clicuri acolo unde ajungea unul.',
