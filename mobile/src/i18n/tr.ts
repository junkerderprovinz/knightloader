...
export const tr: Dict = {
  ...
  'settings.aboutBody': 'Akşamları ve hafta sonlarında, tavsiye edilenden fazla kahveyle yazıldı; çünkü diğer bütün indirme yöneticileri bir tıklamanın yettiği yerde iki tıklama istiyordu.',
  ...
  'settings.aboutGithub': 'GitHub üzerinde',
