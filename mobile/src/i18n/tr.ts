...
export const tr: Dict = {
  ...
  'settings.aboutBody': 'Akşamları ve hafta sonları, tek bir kişi tarafından yazıldı; çünkü diğer bütün indirme yöneticileri, birinin yeteceği yerde iki tıklama istiyordu.',
