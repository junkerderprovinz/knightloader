...
export const tr: Dict = {
  ...
  'settings.aboutBody': 'Tek bir şövalye, tek bir sefer: böylesi olmayan özgür, açık kaynaklı araçlar. Hesap yok, telemetri yok ve okunabilir hiçbir şey kendi surlarının dışına çıkmıyor. Akşamları ve hafta sonları gönülden dövüldü, çünkü beklemek bir seçenek değildi.',
  'settings.accentReset': 'Varsayılan',
  'settings.aboutCoffeeButton': 'Bana bir kahve ısmarla',
  'settings.aboutCoffee': 'KnightLoader ücretsiz ve öyle kalacak. Bir bağış projeyi ayakta tutar ve masrafını karşılar: alan adını, sunucuyu ve ona giden akşamları.',
  ...
  'settings.motionHint': 'Kapalı, gerekli olmayan tüm animasyonları kapatır; İnce, girişleri kısa tutar; Coşkulu ise en zengin deneyimdir.',
};
