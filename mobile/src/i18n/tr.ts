...
export const tr: Dict = {
  ...
  'downloads.startHeld': '{n} bağlantı reddedildi ve başlatılmadı.',
  ...
  'captcha.solverWaitingHint': 'İzliyorsun, bu yüzden çözücüler önce senin yanıtını bekler. Uygulama arka plana geçtiğinde ya da süre dolduğunda, sıranda ilk olan çözücü devralır.',
