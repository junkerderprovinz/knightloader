...
export const fa: Dict = {
  ...
  'settings.aboutBody': 'لشکرکشی با یک زره تنها: ابزارهای آزاد و متن‌باز که این‌گونه وجود نداشتند. نه حسابی، نه سنجش از راه دور، و هیچ چیز خوانایی هرگز از دیوارهای خودت بیرون نمی‌رود. در شب‌ها و آخر هفته‌ها با دل ساخته شده، چون انتظار گزینه‌ای نبود.',
