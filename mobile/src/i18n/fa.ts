...
export const fa: Dict = {
  ...
  'settings.aboutBody': 'یک شوالیه، یک لشکرکشی: ابزارهای آزاد و متن‌باز که این‌گونه وجود نداشتند. نه حسابی، نه سنجش از راه دور، و هیچ چیز خوانایی هرگز از دیوارهای خودت بیرون نمی‌رود. در شب‌ها و آخر هفته‌ها با دل ساخته شده، چون انتظار گزینه‌ای نبود.',
  'settings.accentReset': 'پیش‌فرض',
  'settings.aboutCoffeeButton': 'یک قهوه مهمانم کن',
  'settings.aboutCoffee': 'KnightLoader رایگان است و رایگان می‌ماند. یک کمک مالی پروژه را زنده نگه می‌دارد و هزینه‌هایش را می‌پوشاند: دامنه، سرور و شب‌هایی که صرفش می‌شود.',
  ...
  'settings.motionHint': 'خاموش هر انیمیشن غیرضروری را خاموش می‌کند؛ ملایم ورودها را کوتاه نگه می‌دارد؛ پرشور غنی‌ترین تجربه است.',
};
