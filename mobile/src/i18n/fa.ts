...
export const fa: Dict = {
  ...
  'settings.aboutBody': 'یک مدیر دانلود خودمیزبان با رابط مرتب، به‌عنوان جایگزین JDownloader. موتور، رابط برنامه‌نویسی و رابط کاربری همه در یک برنامه جا می‌گیرند و چیزی برای نصب در کنارش نیست. در شب‌ها و آخر هفته‌ها نوشته شد، چون هر گزینهٔ دیگری دو کلیک می‌خواست، جایی که یکی کافی بود.',
