...
export const hi: Dict = {
  ...
  'connect.qrRelayOnly': 'यह कोड रिले के माध्यम से दो KnightLoader इंस्टेंस को आपस में जोड़ता है और यहां इसका उपयोग नहीं हो सकता - यह ऐप एक क्लाइंट है, इंस्टेंस नहीं। नीचे दिया गया "सीधे नहीं पहुंच पा रहे? रिले के माध्यम से कनेक्ट करें" विकल्प रिले के पते और कुंजी के साथ इस्तेमाल करें।',
