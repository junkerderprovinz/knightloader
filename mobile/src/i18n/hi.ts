...
export const hi: Dict = {
  ...
  'settings.aboutBody': 'एक अकेला शूरवीर, एक अभियान: मुक्त, ओपन-सोर्स औज़ार जो इस रूप में मौजूद नहीं थे। कोई खाता नहीं, कोई टेलीमेट्री नहीं, और पढ़ने लायक कुछ भी कभी आपकी दीवारों से बाहर नहीं जाता। शामों और सप्ताहांतों में दिल से गढ़ा गया, क्योंकि इंतज़ार कोई विकल्प नहीं था।',
  'settings.accentReset': 'डिफ़ॉल्ट',
  'settings.aboutCoffeeButton': 'मुझे कॉफ़ी पिलाएँ',
  'settings.aboutCoffee': 'KnightLoader मुफ़्त है और मुफ़्त ही रहेगा। एक दान परियोजना को जीवित रखता है और उसका खर्च उठाता है: डोमेन, सर्वर और वे शामें जो इसमें लगती हैं।',
  ...
  'settings.motionHint': 'बंद हर गैर-ज़रूरी एनिमेशन को बंद कर देता है; सूक्ष्म प्रवेशों को संक्षिप्त रखता है; जीवंत सबसे समृद्ध अनुभव है।',
};
