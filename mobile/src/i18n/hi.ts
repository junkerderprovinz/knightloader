...
export const hi: Dict = {
  ...
  'settings.aboutBody': 'एक स्व-होस्टेड डाउनलोड मैनेजर, सुथरे इंटरफ़ेस के साथ, JDownloader के विकल्प के रूप में। इंजन, एपीआई और इंटरफ़ेस एक ही प्रोग्राम में रहते हैं, साथ में कुछ और इंस्टॉल करने की ज़रूरत नहीं। शामों और सप्ताहांत में लिखा गया, क्योंकि हर दूसरा वहाँ दो क्लिक माँगता था जहाँ एक ही काफी था।',
  'settings.accentReset': 'डिफ़ॉल्ट',
  'settings.aboutCoffeeButton': 'मुझे कॉफ़ी पिलाएँ',
  'settings.aboutCoffee': 'KnightLoader पसंद आया? एक कॉफ़ी से मेरा दिन बन जाएगा।',
