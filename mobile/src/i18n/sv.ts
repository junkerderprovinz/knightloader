...
export const sv: Dict = {
  ...
  'settings.aboutBody': 'En enda riddare, ett korståg: fria verktyg med öppen källkod som inte fanns i den här formen. Inga konton, ingen telemetri, och inget läsbart lämnar någonsin dina egna murar. Smitt på kvällar och helger med mycket hjärta, för att vänta var inget alternativ.',
  'settings.accentReset': 'Standard',
  'settings.aboutCoffeeButton': 'Bjud på en kaffe',
  'settings.aboutCoffee': 'KnightLoader är gratis och förblir det. En donation håller projektet vid liv och täcker vad det kostar: domänen, servern och kvällarna som går åt.',
