...
export const sv: Dict = {
  ...
  'settings.aboutBody': 'Skrivet på kvällar och helger, på mer kaffe än vad som är tillrådligt, för att alla andra nedladdningsprogram ville ha två klick där ett räckte.',
