...
export const es: Dict = {
  ...
  'settings.aboutBody': 'Escrito por las tardes y los fines de semana, con más café del recomendable, porque cualquier otro gestor de descargas pedía dos clics donde bastaba uno.',
