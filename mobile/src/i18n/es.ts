...
export const es: Dict = {
  ...
  'settings.aboutBody': 'Escrito por las tardes y los fines de semana, por una sola persona, porque cualquier otro gestor de descargas pedía dos clics donde bastaba con uno.',
