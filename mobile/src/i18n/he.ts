...
export const he: Dict = {
  ...
  'downloads.stop': 'עצור',
  'downloads.startHeld': '{n} קישורים נדחו ולא הופעלו.',
  ...
  'captcha.empty': 'אין קאפצ׳ה שממתינה.',
  'captcha.answerLabel': 'תשובה',
  'captcha.answerPlaceholder': 'הקלד את מה שאתה רואה…',
  'captcha.clickHint': 'גע בכל נקודה שהתמונה מבקשת, ואז לחץ על „המשך”.',
  ...
  'captcha.widgetScoreHint': 'אין צורך לגעת בשום דבר. שירות הקאפצ׳ה בודק את הטלפון הזה ומוסר את התשובה שלו בעצמו.',
  'captcha.solve': 'פתור',
  'captcha.widgetUnavailable': 'לא ניתן היה לטעון את האתגר הזה.',
  'captcha.widgetUnreachable': 'הטלפון לא הצליח להגיע למופע או לשירות הקאפצ׳ה. ייתכן שמסנן רשת חוסם את החיבור. „רענון” מנסה שוב.',
  ...
  'captcha.unsolvableTurnstile': 'KnightLoader לא יכול להציג בעצמו אתגר של Cloudflare Turnstile, ולכן רק פותר בתשלום שהוגדר בהגדרות הקאפצ׳ה של המופע יכול לענות עליו. „ביטול” מדלג על הקאפצ׳ה הזו.',
  ...
  'captcha.solverWaitingHint': 'אתה צופה, ולכן הפותרים מחכים קודם לתשובה שלך. ברגע שהאפליקציה עוברת לרקע או שהזמן נגמר, הפותר הראשון בסדר שלך מטפל בה.',
