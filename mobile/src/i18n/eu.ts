...
export const eu: Dict = {
  ...
  'settings.aboutBody': 'Arratsaldeetan eta asteburuetan idatzia, komeni dena baino kafe gehiagorekin, beste deskarga-kudeatzaile guztiek bi klik nahi zituztelako bat nahikoa zen tokian.',
