...
export const eu: Dict = {
  ...
  'downloads.startHeld': '{n} esteka baztertu dira eta ez dira abiatu.',
  ...
  'captcha.solverWaitingHint': 'Begira zaude, beraz ebazleak zure erantzunaren zain egoten dira lehenik. Aplikazioa atzeko planoan dagoenean edo denbora amaitzen denean, zure ordenako lehen ebazleak hartzen du.',
