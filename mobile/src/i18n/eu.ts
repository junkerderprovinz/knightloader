...
export const eu: Dict = {
  ...
  'settings.aboutBody': 'Zaldun bakar bat, kanpaina bat: horrela existitzen ez ziren tresna libre eta kode irekikoak. Konturik ez, telemetriarik ez, eta irakur daitekeen ezerk ez ditu inoiz zure harresiak uzten. Arratsaldeetan eta asteburuetan bihotzez forjatua, itxarotea aukera ez zelako.',
  'settings.accentReset': 'Lehenetsia',
  'settings.aboutCoffeeButton': 'Erosi kafe bat',
  'settings.aboutCoffee': 'KnightLoader doakoa da eta hala jarraituko du. Dohaintza batek proiektua bizirik mantentzen du eta kostuak estaltzen ditu: domeinua, zerbitzaria eta bertan sartzen diren arratsaldeak.',
