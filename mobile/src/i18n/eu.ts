...
export const eu: Dict = {
  ...
  'settings.aboutBody': 'Arratsaldeetan eta asteburuetan idatzia, pertsona bakar batek, beste deskarga-kudeatzaile orok bi klik eskatzen zituelako bat nahikoa zen tokian.',
