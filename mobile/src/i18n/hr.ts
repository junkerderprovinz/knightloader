...
export const hr: Dict = {
  ...
  'settings.aboutBody': 'Napisano navečer i vikendom, uz više kave nego što je razumno, jer je svaki drugi upravitelj preuzimanja tražio dva klika ondje gdje je bio dovoljan jedan.',
