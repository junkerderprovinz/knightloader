...
export const hr: Dict = {
  ...
  'settings.aboutBody': 'Jedan vitez, jedan pohod: slobodni alati otvorenog koda kakvih nije bilo. Nikakvih računa, nikakve telemetrije i ništa čitljivo nikada ne napušta tvoje zidine. Kovano večerima i vikendima sa srcem, jer čekanje nije bilo opcija.',
  'settings.accentReset': 'Zadano',
  'settings.aboutCoffeeButton': 'Počasti me kavom',
  'settings.aboutCoffee': 'KnightLoader je besplatan i takav ostaje. Donacija drži projekt na životu i pokriva ono što košta: domenu, poslužitelj i večeri koje u njega odlaze.',
