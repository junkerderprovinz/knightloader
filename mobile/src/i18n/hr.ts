...
export const hr: Dict = {
  ...
  'settings.aboutBody': 'Napisano navečer i vikendom, od strane jedne osobe, jer je svaki drugi upravitelj preuzimanja tražio dva klika ondje gdje je bio dovoljan jedan.',
