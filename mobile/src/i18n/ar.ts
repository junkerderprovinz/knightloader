...
export const ar: Dict = {
  ...
  'settings.aboutBody': 'حملة بدرع واحد: أدوات حرة مفتوحة المصدر لم تكن موجودة هكذا. لا حسابات، ولا قياس عن بُعد، ولا شيء مقروء يغادر أسوارك أبدًا. طُرقت في الأمسيات وعطلات نهاية الأسبوع بشغف، لأن الانتظار لم يكن خيارًا.',
