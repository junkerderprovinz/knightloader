...
export const ar: Dict = {
  ...
  'settings.aboutBody': 'مدير تنزيل مستضاف ذاتيًا بواجهة مرتبة، كبديل لـ JDownloader. المحرك والواجهة البرمجية وواجهة الاستخدام كلها في برنامج واحد، ولا شيء آخر يُثبَّت إلى جانبه. كُتب في الأمسيات وعطلات نهاية الأسبوع، لأن كل بديل آخر كان يطلب نقرتين حيث تكفي نقرة واحدة.',
  'settings.accentReset': 'الافتراضي',
  'settings.aboutCoffeeButton': 'اشترِ لي قهوة',
  'settings.aboutCoffee': 'هل يعجبك KnightLoader؟ فنجان قهوة سيسعد يومي.',
