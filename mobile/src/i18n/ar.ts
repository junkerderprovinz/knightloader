...
export const ar: Dict = {
  ...
  'settings.aboutBody': 'كُتب في الأمسيات وعطلات نهاية الأسبوع، بقهوة أكثر مما ينبغي، لأن كل مدير تنزيل آخر كان يطلب نقرتين حيث تكفي واحدة.',
  ...
  'settings.aboutGithub': 'على GitHub',
