...
export const pl: Dict = {
  ...
  'settings.aboutBody': 'Napisane wieczorami i w weekendy, przy większej ilości kawy, niż wypada, bo każdy inny menedżer pobierania chciał dwóch kliknięć tam, gdzie wystarczyło jedno.',
