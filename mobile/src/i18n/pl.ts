...
export const pl: Dict = {
  ...
  'settings.aboutBody': 'Napisane wieczorami i w weekendy, przez jedną osobę, bo każdy inny menedżer pobierania chciał dwóch kliknięć tam, gdzie wystarczyło jedno.',
