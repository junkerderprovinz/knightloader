...
export const pl: Dict = {
  ...
  'settings.aboutBody': 'Jeden rycerz, jedna wyprawa: wolne, otwartoźródłowe narzędzia, których w tej postaci nie było. Żadnych kont, żadnej telemetrii i nic czytelnego nigdy nie opuszcza twoich murów. Kute wieczorami i w weekendy z sercem, bo czekanie nie wchodziło w grę.',
  'settings.accentReset': 'Domyślny',
  'settings.aboutCoffeeButton': 'Postaw mi kawę',
  'settings.aboutCoffee': 'KnightLoader jest darmowy i taki zostanie. Darowizna utrzymuje projekt przy życiu i pokrywa jego koszty: domenę, serwer i wieczory, które w niego idą.',
  ...
  'settings.motionHint': 'Wyłączone wyłącza każdą zbędną animację; Subtelne skraca pojawienia się; Dzikie to najbogatsze wrażenia.',
};
