...
export const pl: Dict = {
  ...
  'downloads.startHeld': '{n} link(ów) odrzucono i nie uruchomiono.',
  ...
  'captcha.solverWaitingHint': 'Patrzysz, więc solvery najpierw czekają na twoją odpowiedź. Gdy aplikacja przejdzie w tło albo skończy się czas, przejmuje pierwszy solver z twojej kolejności.',
