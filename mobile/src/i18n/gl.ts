...
export const gl: Dict = {
  ...
  'settings.aboutBody': 'Un só cabaleiro, unha cruzada: ferramentas libres e de código aberto que non existían así. Sen contas, sen telemetría, e nada lexible sae nunca dos teus propios muros. Forxado polas noites e as fins de semana con moito corazón, porque agardar non era unha opción.',
  'settings.accentReset': 'Por defecto',
  'settings.aboutCoffeeButton': 'Convídame a un café',
  'settings.aboutCoffee': 'KnightLoader é gratuíto e seguirao sendo. Unha doazón mantén vivo o proxecto e cobre o que custa: o dominio, o servidor e as noites que van nel.',
