...
export const gl: Dict = {
  ...
  'settings.aboutBody': 'Escrito polas noites e as fins de semana, por unha soa persoa, porque calquera outro xestor de descargas pedía dous clics onde abondaba un.',
