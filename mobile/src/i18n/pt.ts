...
export const pt: Dict = {
  ...
  'settings.aboutBody': 'Um só cavaleiro, uma cruzada: ferramentas livres e de código aberto que não existiam assim. Sem contas, sem telemetria, e nada legível sai alguma vez das tuas próprias muralhas. Forjado em noites e fins de semana com muito coração, porque esperar não era opção.',
  'settings.accentReset': 'Predefinição',
  'settings.aboutCoffeeButton': 'Paga-me um café',
  'settings.aboutCoffee': 'O KnightLoader é grátis e assim fica. Um donativo mantém o projeto vivo e cobre o que ele custa: o domínio, o servidor e as noites que lhe são dadas.',
  ...
  'settings.aboutMail': 'Enviar um e-mail',
