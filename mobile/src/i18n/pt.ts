...
export const pt: Dict = {
  ...
  'settings.aboutBody': 'Escrito à noite e aos fins de semana, com mais café do que é aconselhável, porque todos os outros gestores de transferências queriam dois cliques onde bastava um.',
  ...
  'settings.aboutGithub': 'No GitHub',
