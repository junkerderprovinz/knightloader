...
export const pt: Dict = {
  ...
  'settings.aboutBody': 'Escrito à noite e aos fins de semana, por uma só pessoa, porque todos os outros gestores de transferências pediam dois cliques onde bastava um.',
