...
export const fr: Dict = {
  ...
  'settings.aboutBody': 'Écrit le soir et le week-end, par une seule personne, parce que tous les autres gestionnaires de téléchargement demandaient deux clics là où un seul suffisait.',
