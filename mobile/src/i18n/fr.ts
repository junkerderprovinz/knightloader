...
export const fr: Dict = {
  ...
  'settings.aboutBody': 'Écrit le soir et le week-end, avec plus de café que de raison, parce que tous les autres gestionnaires de téléchargement voulaient deux clics là où un seul suffisait.',
  ...
  'settings.aboutGithub': 'Sur GitHub',
