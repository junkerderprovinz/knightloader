...
export const fr: Dict = {
  ...
  'settings.aboutBody': 'Un seul chevalier, une croisade : des outils libres et open source qui n\'existaient pas sous cette forme. Pas de comptes, pas de télémétrie, et rien de lisible ne quitte jamais vos propres murs. Forgé le soir et le week-end avec beaucoup de cœur, parce qu\'attendre n\'était pas une option.',
  'settings.accentReset': 'Par défaut',
  'settings.aboutCoffeeButton': 'Offrir un café',
  'settings.aboutCoffee': 'KnightLoader est gratuit et le restera. Un don garde le projet en vie et couvre ce qu\'il coûte : le domaine, le serveur et les soirées qui y passent.',
