...
export const fr: Dict = {
  ...
  'downloads.startHeld': '{n} lien(s) ont été refusé(s) et n’ont pas démarré.',
  ...
  'captcha.solverWaitingHint': 'Vous regardez, donc les solveurs attendent d’abord votre réponse. Dès que l’application passe en arrière-plan ou que le délai expire, le premier solveur dans votre ordre prend le relais.',
