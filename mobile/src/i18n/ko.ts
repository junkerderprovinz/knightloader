...
export const ko: Dict = {
  ...
  'settings.aboutBody': '기사 한 사람의 원정. 이런 모습으로는 없던 자유롭고 오픈 소스인 도구입니다. 계정도 없고 텔레메트리도 없으며, 읽을 수 있는 것은 결코 당신의 성벽 밖으로 나가지 않습니다. 기다리는 것은 선택지가 아니었기에 저녁과 주말에 마음을 담아 벼렸습니다.',
  'settings.accentReset': '기본값',
  'settings.aboutCoffeeButton': '커피 사주기',
  'settings.aboutCoffee': 'KnightLoader는 무료이고 앞으로도 무료입니다. 후원은 프로젝트를 살아 있게 하고 비용을 메웁니다. 도메인과 서버, 그리고 여기에 들어가는 저녁 시간입니다.',
