...
export const is: Dict = {
  ...
  'downloads.startHeld': '{n} tenglum var hafnað og þeir fóru ekki af stað.',
  ...
  'captcha.solverWaitingHint': 'Þú fylgist með, svo lausnararnir bíða fyrst eftir svari frá þér. Um leið og forritið fer í bakgrunninn eða tíminn rennur út, tekur fyrsti lausnarinn í röðinni þinni við.',
