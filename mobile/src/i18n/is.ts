...
export const is: Dict = {
  ...
  'settings.aboutBody': 'Einn riddari, ein krossferð: frjáls verkfæri með opnum kóða sem voru ekki til svona. Engir reikningar, engin fjarmæling og ekkert læsilegt fer nokkurn tíma út fyrir þína eigin múra. Smíðað á kvöldin og um helgar af heilum hug, því að bíða var ekki valkostur.',
  'settings.accentReset': 'Sjálfgefið',
  'settings.aboutCoffeeButton': 'Bjóddu mér kaffi',
  'settings.aboutCoffee': 'KnightLoader er ókeypis og verður það áfram. Framlag heldur verkefninu á lífi og stendur undir því sem það kostar: léninu, þjóninum og kvöldunum sem fara í það.',
