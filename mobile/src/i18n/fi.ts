...
export const fi: Dict = {
  ...
  'settings.aboutBody': 'Kirjoitettu iltaisin ja viikonloppuisin, useammalla kahvilla kuin on järkevää, koska jokainen muu latausohjelma halusi kaksi klikkausta siihen mihin yksi riitti.',
  ...
  'settings.aboutGithub': 'GitHubissa',
