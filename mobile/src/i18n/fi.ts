...
export const fi: Dict = {
  ...
  'settings.aboutBody': 'Kirjoitettu iltaisin ja viikonloppuisin, yhden ihmisen voimin, koska jokainen muu lataustenhallinta halusi kaksi klikkausta siinä missä yksi olisi riittänyt.',
