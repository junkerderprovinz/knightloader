...
export const fi: Dict = {
  ...
  'settings.aboutBody': 'Yksi ritari, yksi ristiretki: vapaita, avoimen lähdekoodin työkaluja, joita ei tällaisina ollut. Ei tilejä, ei telemetriaa, eikä mikään luettava poistu koskaan omien muuriesi sisältä. Taottu iltaisin ja viikonloppuisin sydämellä, koska odottaminen ei ollut vaihtoehto.',
  'settings.accentReset': 'Oletus',
  'settings.aboutCoffeeButton': 'Tarjoa kahvi',
  'settings.aboutCoffee': 'KnightLoader on ilmainen ja pysyy sellaisena. Lahjoitus pitää projektin hengissä ja kattaa sen kulut: verkkotunnuksen, palvelimen ja illat, jotka siihen kuluvat.',
  ...
  'settings.motionHint': 'Pois kytkee pois kaikki ei-välttämättömät animaatiot; Hienovarainen pitää saapumiset lyhyinä; Villi on rikkain kokemus.',
};
