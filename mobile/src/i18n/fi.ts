...
export const fi: Dict = {
  ...
  'downloads.startHeld': '{n} linkkiä hylättiin eikä niitä käynnistetty.',
  ...
  'captcha.solverWaitingHint': 'Seuraat, joten ratkaisijat odottavat ensin vastaustasi. Kun sovellus on taustalla tai aika loppuu, järjestyksesi ensimmäinen ratkaisija ottaa captchan hoitaakseen.',
