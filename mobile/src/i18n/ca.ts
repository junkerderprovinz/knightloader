...
export const ca: Dict = {
  ...
  'settings.aboutBody': 'Escrit als vespres i els caps de setmana, amb més cafè del que és aconsellable, perquè tots els altres gestors de baixades volien dos clics on en bastava un.',
