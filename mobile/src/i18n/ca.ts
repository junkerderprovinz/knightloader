...
export const ca: Dict = {
  ...
  'settings.aboutBody': 'Un sol cavaller, una croada: eines lliures i de codi obert que no existien així. Sense comptes, sense telemetria, i res llegible no surt mai de les teves pròpies muralles. Forjat als vespres i els caps de setmana amb molt de cor, perquè esperar no era una opció.',
  'settings.accentReset': 'Per defecte',
  'settings.aboutCoffeeButton': 'Convida’m a un cafè',
  'settings.aboutCoffee': 'KnightLoader és gratuït i ho seguirà sent. Un donatiu manté viu el projecte i cobreix el que costa: el domini, el servidor i els vespres que hi van.',
