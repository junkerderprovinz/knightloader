...
export const ca: Dict = {
  ...
  'settings.aboutBody': 'Escrit als vespres i els caps de setmana, per una sola persona, perquè qualsevol altre gestor de baixades demanava dos clics on n\'hi hauria prou amb un.',
