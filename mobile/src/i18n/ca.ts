...
export const ca: Dict = {
  ...
  'downloads.startHeld': '{n} enllaç(os) s’han rebutjat i no s’han iniciat.',
  ...
  'captcha.solverWaitingHint': 'Estàs mirant, així que els solucionadors esperen primer la teva resposta. Tan bon punt l’aplicació passi a segon pla o s’acabi el temps, pren el relleu el primer solucionador segons el teu ordre.',
