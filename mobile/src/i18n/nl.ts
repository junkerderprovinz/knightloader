...
export const nl: Dict = {
  ...
  'settings.aboutBody': 'Geschreven in de avonden en weekenden, op meer koffie dan verstandig is, omdat elke andere downloadmanager twee klikken wilde waar er één volstond.',
  ...
  'settings.aboutGithub': 'Op GitHub',
