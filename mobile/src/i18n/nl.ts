...
export const nl: Dict = {
  ...
  'settings.aboutBody': 'Eén ridder, één kruistocht: vrije, opensource gereedschappen die zo niet bestonden. Geen accounts, geen telemetrie, en niets leesbaars verlaat ooit je eigen muren. In avonden en weekenden gesmeed met veel hart, omdat wachten geen optie was.',
  'settings.accentReset': 'Standaard',
  'settings.aboutCoffeeButton': 'Trakteer op koffie',
  'settings.aboutCoffee': 'KnightLoader is gratis en blijft gratis. Een donatie houdt het project in leven en dekt wat het kost: het domein, de server en de avonden die erin gaan.',
