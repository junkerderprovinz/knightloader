...
export const vi: Dict = {
  ...
  'settings.aboutBody': 'Được viết vào buổi tối và cuối tuần, với nhiều cà phê hơn mức nên có, vì mọi trình quản lý tải xuống khác đều đòi hai cú nhấp ở nơi một cú là đủ.',
