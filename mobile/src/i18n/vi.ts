...
export const vi: Dict = {
  ...
  'settings.aboutBody': 'Một hiệp sĩ, một cuộc chinh phạt: những công cụ tự do, mã nguồn mở mà trước đó chưa từng có. Không tài khoản, không đo từ xa, và không có gì đọc được rời khỏi những bức tường của bạn. Được rèn vào buổi tối và cuối tuần bằng cả trái tim, vì chờ đợi không phải là một lựa chọn.',
  'settings.accentReset': 'Mặc định',
  'settings.aboutCoffeeButton': 'Mời tôi ly cà phê',
  'settings.aboutCoffee': 'KnightLoader miễn phí và sẽ luôn như vậy. Một khoản đóng góp giữ cho dự án sống và trang trải chi phí: tên miền, máy chủ và những buổi tối dành cho nó.',
