...
export const vi: Dict = {
  ...
  'downloads.stop': 'Dừng',
  'downloads.startHeld': '{n} liên kết đã bị từ chối nên không được bắt đầu.',
  ...
  'captcha.open': 'Trả lời',
  'captcha.waiting': 'Một captcha cho {host} đang chờ câu trả lời.',
  'captcha.empty': 'Không có captcha nào đang chờ.',
  'captcha.answerLabel': 'Câu trả lời',
  'captcha.answerPlaceholder': 'Nhập những gì bạn thấy…',
  'captcha.clickHint': 'Chạm vào mọi điểm mà hình ảnh yêu cầu, rồi nhấn Tiếp tục.',
  ...
  'captcha.widgetScoreHint': 'Bạn không cần chạm vào gì cả. Dịch vụ captcha sẽ kiểm tra điện thoại này và tự giao câu trả lời.',
  'captcha.solve': 'Giải',
  'captcha.widgetUnavailable': 'Không thể tải thử thách này.',
  'captcha.widgetUnreachable': 'Điện thoại không kết nối được tới phiên bản hoặc dịch vụ captcha. Có thể một bộ lọc mạng đang chặn nó. Làm mới sẽ thử lại.',
  ...
  'captcha.unsolvableTurnstile': 'KnightLoader không tự hiển thị được thử thách Cloudflare Turnstile, nên chỉ một trình giải trả phí được thiết lập trong phần cài đặt Captcha của phiên bản mới trả lời được nó. Hủy sẽ bỏ qua captcha này.',
  ...
  'captcha.solverWaitingHint': 'Bạn đang xem, nên các trình giải chờ câu trả lời của bạn trước. Khi ứng dụng ở phía sau hoặc hết thời gian, trình giải đầu tiên trong thứ tự của bạn sẽ tiếp quản.',
