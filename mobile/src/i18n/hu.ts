...
export const hu: Dict = {
  ...
  'settings.aboutBody': 'Egy lovag, egy hadjárat: szabad, nyílt forráskódú eszközök, amelyek így nem léteztek. Semmi fiók, semmi telemetria, és semmi olvasható nem hagyja el a saját falaidat. Estéken és hétvégéken kovácsolva, sok szívvel, mert a várakozás nem volt opció.',
  'settings.accentReset': 'Alapérték',
  'settings.aboutCoffeeButton': 'Hívj meg egy kávéra',
  'settings.aboutCoffee': 'A KnightLoader ingyenes, és az is marad. Egy adomány életben tartja a projektet, és fedezi, amibe kerül: a domaint, a szervert és az esti órákat, amik belemennek.',
