...
export const el: Dict = {
  ...
  'settings.motionHint': 'Το Ανενεργό απενεργοποιεί κάθε μη απαραίτητη κίνηση· το Διακριτικό κρατά τις εμφανίσεις σύντομες· το Έντονο είναι η πλουσιότερη εμπειρία.',
};
