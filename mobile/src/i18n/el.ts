...
export const el: Dict = {
  ...
  'settings.aboutBody': 'Ένας ιππότης, μία σταυροφορία: ελεύθερα εργαλεία ανοιχτού κώδικα που δεν υπήρχαν έτσι. Κανένας λογαριασμός, καμία τηλεμετρία, και τίποτα αναγνώσιμο δεν φεύγει ποτέ από τα δικά σου τείχη. Σφυρηλατημένο τα βράδια και τα σαββατοκύριακα με πολλή καρδιά, γιατί η αναμονή δεν ήταν επιλογή.',
  'settings.accentReset': 'Προεπιλογή',
  'settings.aboutCoffeeButton': 'Κέρασέ με έναν καφέ',
  'settings.aboutCoffee': 'Το KnightLoader είναι δωρεάν και θα παραμείνει. Μια δωρεά κρατά το έργο ζωντανό και καλύπτει όσα κοστίζει: το domain, τον διακομιστή και τα βράδια που πηγαίνουν σε αυτό.',
  ...
  'settings.motionHint': 'Το Ανενεργό απενεργοποιεί κάθε μη απαραίτητη κίνηση· το Διακριτικό κρατά τις εμφανίσεις σύντομες· το Πλήρες είναι η πλουσιότερη εμπειρία.',
};
