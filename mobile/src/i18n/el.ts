...
export const el: Dict = {
  ...
  'settings.aboutBody': 'Γράφτηκε τα βράδια και τα σαββατοκύριακα, από ένα μόνο άτομο, επειδή κάθε άλλος διαχειριστής λήψεων ήθελε δύο κλικ εκεί που έφτανε ένα.',
