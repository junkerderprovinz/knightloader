...
export const el: Dict = {
  ...
  'settings.aboutBody': 'Γράφτηκε τα βράδια και τα σαββατοκύριακα, με περισσότερο καφέ απ’ όσο συνιστάται, επειδή κάθε άλλος διαχειριστής λήψεων ήθελε δύο κλικ εκεί που έφτανε ένα.',
