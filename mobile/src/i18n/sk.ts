...
export const sk: Dict = {
  ...
  'settings.aboutBody': 'Jeden rytier, jedno ťaženie: slobodné nástroje s otvoreným kódom, ktoré takto neexistovali. Žiadne účty, žiadna telemetria a nič čitateľné nikdy neopustí tvoje vlastné hradby. Kované po večeroch a cez víkendy so srdcom, pretože čakať sa nedalo.',
  'settings.accentReset': 'Predvolené',
  'settings.aboutCoffeeButton': 'Kúp mi kávu',
  'settings.aboutCoffee': 'KnightLoader je zadarmo a zostane. Dar drží projekt nažive a pokryje, čo stojí: doménu, server a večery, ktoré doň idú.',
  ...
  'settings.motionHint': 'Vypnuté vypne každú nepodstatnú animáciu; Jemné udržiava vstupy krátke; Divoké je najbohatší zážitok.',
};
