...
export const sk: Dict = {
  ...
  'settings.aboutBody': 'Napísané po večeroch a cez víkendy, pri viac kávy, než je rozumné, pretože každý iný správca sťahovania chcel dve kliknutia tam, kde stačilo jedno.',
  ...
  'settings.aboutGithub': 'Na GitHube',
