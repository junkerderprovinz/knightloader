...
export const sl: Dict = {
  ...
  'settings.aboutBody': 'Napisano zvečer in ob koncih tedna, s strani ene osebe, ker je vsak drug upravitelj prenosov hotel dva klika tam, kjer je zadostoval en.',
