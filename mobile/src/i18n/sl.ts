...
export const sl: Dict = {
  ...
  'downloads.startHeld': '{n} povezav je zavrnjenih in se niso zagnale.',
  ...
  'captcha.solverWaitingHint': 'Gledaš, zato reševalci najprej čakajo na tvoj odgovor. Ko je aplikacija v ozadju ali se čas izteče, prevzame prvi reševalec v tvojem vrstnem redu.',
