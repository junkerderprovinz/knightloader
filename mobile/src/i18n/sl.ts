...
export const sl: Dict = {
  ...
  'settings.aboutBody': 'En vitez, en pohod: prosta odprtokodna orodja, kakršnih ni bilo. Nobenih računov, nobene telemetrije in nič berljivega nikoli ne zapusti tvojih zidov. Kovano ob večerih in koncih tedna s srcem, ker čakanje ni bilo možnost.',
  'settings.accentReset': 'Privzeto',
  'settings.aboutCoffeeButton': 'Časti kavo',
  'settings.aboutCoffee': 'KnightLoader je brezplačen in tak ostaja. Donacija ohranja projekt pri življenju in pokrije, kar stane: domeno, strežnik in večere, ki gredo vanj.',
