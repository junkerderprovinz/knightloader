...
export const sl: Dict = {
  ...
  'settings.aboutBody': 'Napisano zvečer in ob vikendih, ob več kave, kot je pametno, ker je vsak drug upravitelj prenosov hotel dva klika tam, kjer je zadostoval en.',
