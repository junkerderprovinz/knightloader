...
export const da: Dict = {
  ...
  'settings.aboutBody': 'Skrevet om aftenen og i weekenden, på mere kaffe end tilrådeligt, fordi alle andre downloadprogrammer ville have to klik, hvor ét var nok.',
