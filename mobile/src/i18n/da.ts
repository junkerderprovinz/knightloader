...
export const da: Dict = {
  ...
  'downloads.stop': 'Stop',
  'downloads.startHeld': '{n} link(s) blev afvist og ikke startet.',
  ...
  'captcha.solverWaitingHint': 'Du kigger med, så løserne venter først på dit svar. Så snart appen er i baggrunden, eller tiden løber ud, tager den første løser i din rækkefølge over.',
