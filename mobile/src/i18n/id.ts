...
export const id: Dict = {
  ...
  'settings.aboutBody': 'Satu ksatria, satu kampanye: perkakas bebas dan sumber terbuka yang belum pernah ada seperti ini. Tanpa akun, tanpa telemetri, dan tidak ada yang terbaca pernah meninggalkan tembokmu sendiri. Ditempa pada malam hari dan akhir pekan dengan sepenuh hati, karena menunggu bukan pilihan.',
  'settings.accentReset': 'Bawaan',
  'settings.aboutCoffeeButton': 'Traktir saya kopi',
  'settings.aboutCoffee': 'KnightLoader gratis dan akan tetap begitu. Donasi menjaga proyek ini tetap hidup dan menutup biayanya: domain, server, dan malam-malam yang tercurah ke dalamnya.',
