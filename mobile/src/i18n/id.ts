...
export const id: Dict = {
  ...
  'settings.aboutBody': 'Ditulis pada malam hari dan akhir pekan, oleh satu orang, karena setiap pengelola unduhan lain meminta dua klik di tempat satu saja sudah cukup.',
