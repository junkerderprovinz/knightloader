...
export const id: Dict = {
  ...
  'settings.aboutBody': 'Ditulis pada malam hari dan akhir pekan, dengan kopi lebih banyak dari yang dianjurkan, karena setiap pengelola unduhan lain meminta dua klik di tempat satu sudah cukup.',
