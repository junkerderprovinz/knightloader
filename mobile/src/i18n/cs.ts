...
export const cs: Dict = {
  ...
  'settings.aboutBody': 'Napsáno po večerech a o víkendech, u víc kávy, než je zdrávo, protože každý jiný správce stahování chtěl dvě kliknutí tam, kde stačilo jedno.',
