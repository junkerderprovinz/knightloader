...
export const cs: Dict = {
  ...
  'settings.aboutBody': 'Jeden rytíř, jedno tažení: svobodné nástroje s otevřeným kódem, které takto neexistovaly. Žádné účty, žádná telemetrie a nic čitelného nikdy neopustí tvé vlastní hradby. Kováno po večerech a o víkendech se srdcem, protože čekat nešlo.',
  'settings.accentReset': 'Výchozí',
  'settings.aboutCoffeeButton': 'Kup mi kávu',
  'settings.aboutCoffee': 'KnightLoader je zdarma a zůstane. Dar drží projekt naživu a pokryje, co stojí: doménu, server a večery, které do něj jdou.',
  ...
  'settings.aboutMail': 'Poslat e-mail',
