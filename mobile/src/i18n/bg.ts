...
export const bg: Dict = {
  ...
  'downloads.stop': 'Спри',
  'downloads.startHeld': '{n} връзки са отхвърлени и не са стартирани.',
  ...
  'captcha.solverWaitingHint': 'Гледаш, затова решаващите услуги първо чакат твоя отговор. Щом приложението е на заден план или времето изтече, поема първата решаваща услуга в твоя ред.',
