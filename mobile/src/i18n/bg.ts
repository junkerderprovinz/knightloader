...
export const bg: Dict = {
  ...
  'settings.aboutBody': 'Написано вечер и през почивните дни, от един човек, защото всеки друг мениджър за изтегляния искаше две кликвания там, където стигаше едно.',
