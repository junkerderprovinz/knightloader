...
export const bg: Dict = {
  ...
  'settings.aboutBody': 'Написано във вечерите и почивните дни, с повече кафе от разумното, защото всеки друг мениджър за изтегляния искаше две кликвания там, където стигаше едно.',
