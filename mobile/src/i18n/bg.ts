...
export const bg: Dict = {
  ...
  'settings.aboutBody': 'Поход в една-единствена броня: свободни инструменти с отворен код, каквито ги нямаше. Никакви акаунти, никаква телеметрия и нищо четимо никога не напуска собствените ти стени. Изковано вечер и през почивните дни със сърце, защото чакането не беше вариант.',
