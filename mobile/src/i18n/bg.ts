...
export const bg: Dict = {
  ...
  'settings.aboutBody': 'Самостоятелно хостван мениджър за изтегляния с подреден интерфейс, като алтернатива на JDownloader. Ядрото, API-то и интерфейсът се събират в една програма, до нея няма какво да се инсталира. Написано вечер и през почивните дни, защото всеки друг искаше две кликвания там, където стигаше едно.',
  'settings.accentReset': 'По подразбиране',
  'settings.aboutCoffeeButton': 'Почерпи ме с кафе',
  'settings.aboutCoffee': 'Харесва ли ви KnightLoader? Едно кафе би ми направило деня.',
