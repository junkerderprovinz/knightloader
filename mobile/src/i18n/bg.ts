...
export const bg: Dict = {
  ...
  'settings.aboutBody': 'Един рицар, един поход: свободни инструменти с отворен код, каквито ги нямаше. Никакви акаунти, никаква телеметрия и нищо четимо никога не напуска собствените ти стени. Изковано вечер и през почивните дни със сърце, защото чакането не беше вариант.',
  'settings.accentReset': 'По подразбиране',
  'settings.aboutCoffeeButton': 'Почерпи ме с кафе',
  'settings.aboutCoffee': 'KnightLoader е безплатен и ще си остане такъв. Дарението държи проекта жив и покрива това, което струва: домейна, сървъра и вечерите, които влизат в него.',
  ...
  'settings.aboutMail': 'Прати имейл',
  ...
  'settings.motionHint': 'Изкл. изключва всяка ненужна анимация; Дискретно прави появяванията кратки; Пълно е най-богатото изживяване.',
};
