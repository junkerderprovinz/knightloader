...
export const ms: Dict = {
  ...
  'settings.aboutBody': 'Seorang kesateria, satu kempen: alat bebas sumber terbuka yang tidak pernah wujud begini. Tiada akaun, tiada telemetri, dan tiada apa pun yang boleh dibaca meninggalkan tembokmu sendiri. Ditempa pada waktu malam dan hujung minggu dengan sepenuh hati, kerana menunggu bukan pilihan.',
  'settings.accentReset': 'Lalai',
  'settings.aboutCoffeeButton': 'Belanja saya kopi',
  'settings.aboutCoffee': 'KnightLoader percuma dan akan kekal begitu. Derma memastikan projek ini terus hidup dan menampung kosnya: domain, pelayan dan malam-malam yang dicurahkan padanya.',
