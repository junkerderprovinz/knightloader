...
export const ms: Dict = {
  ...
  'settings.aboutBody': 'Ditulis pada waktu petang dan hujung minggu, dengan lebih banyak kopi daripada yang wajar, kerana setiap pengurus muat turun lain mahukan dua klik di tempat satu sudah memadai.',
