...
export const ms: Dict = {
  ...
  'settings.aboutBody': 'Ditulis pada waktu malam dan hujung minggu, oleh seorang sahaja, kerana setiap pengurus muat turun lain mahukan dua klik di tempat satu sudah memadai.',
