...
export const uk: Dict = {
  ...
  'settings.aboutBody': 'Похід в одних-єдиних обладунках: вільні інструменти з відкритим кодом, яких у такому вигляді не було. Жодних облікових записів, жодної телеметрії, і нічого читабельного ніколи не залишає твоїх мурів. Викувано вечорами та у вихідні від душі, бо чекати було годі.',
