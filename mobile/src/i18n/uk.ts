...
export const uk: Dict = {
  ...
  'settings.aboutBody': 'Написано вечорами та у вихідні, на більшій кількості кави, ніж варто, бо кожен інший менеджер завантажень хотів два кліки там, де вистачало одного.',
