...
export const uk: Dict = {
  ...
  'settings.aboutBody': 'Один лицар, один похід: вільні інструменти з відкритим кодом, яких у такому вигляді не було. Жодних облікових записів, жодної телеметрії, і нічого читабельного ніколи не залишає твоїх мурів. Викувано вечорами та у вихідні від душі, бо чекати було годі.',
  'settings.accentReset': 'За замовчуванням',
  'settings.aboutCoffeeButton': 'Пригостити кавою',
  'settings.aboutCoffee': 'KnightLoader безкоштовний і таким лишиться. Пожертва тримає проєкт живим і покриває його витрати: домен, сервер і вечори, які в нього йдуть.',
  ...
  'settings.motionHint': 'Вимк. вимикає кожну необов\'язкову анімацію; Стримано робить появи короткими; Повно — найбагатший варіант.',
};
