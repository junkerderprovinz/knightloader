...
export const uk: Dict = {
  ...
  'settings.aboutBody': 'Самостійно розміщений менеджер завантажень з охайним інтерфейсом, як альтернатива JDownloader. Рушій, API та інтерфейс містяться в одній програмі, поруч нема чого встановлювати. Написано вечорами та у вихідні, бо будь-який інший вимагав два кліки там, де вистачало одного.',
  'settings.accentReset': 'За замовчуванням',
  'settings.aboutCoffeeButton': 'Пригостити кавою',
  'settings.aboutCoffee': 'Подобається KnightLoader? Чашка кави підніме мені настрій.',
