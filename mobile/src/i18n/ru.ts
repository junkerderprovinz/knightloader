...
export const ru: Dict = {
  ...
  'settings.aboutBody': 'Самостоятельно размещаемый менеджер загрузок с опрятным интерфейсом, как альтернатива JDownloader. Движок, API и интерфейс умещаются в одной программе, рядом ставить нечего. Написано по вечерам и выходным, потому что любой другой требовал два щелчка там, где хватало одного.',
  'settings.accentReset': 'По умолчанию',
  'settings.aboutCoffeeButton': 'Угостить кофе',
  'settings.aboutCoffee': 'Нравится KnightLoader? Чашка кофе поднимет мне настроение.',
