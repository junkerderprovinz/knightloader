...
export const ru: Dict = {
  ...
  'settings.aboutBody': 'Написано вечерами и по выходным, на большем количестве кофе, чем разумно, потому что любой другой менеджер загрузок требовал два клика там, где хватало одного.',
