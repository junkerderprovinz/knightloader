...
export const ru: Dict = {
  ...
  'settings.aboutBody': 'Написано по вечерам и выходным, одним человеком, потому что любой другой менеджер загрузок требовал два щелчка там, где хватало одного.',
