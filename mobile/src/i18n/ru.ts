...
export const ru: Dict = {
  ...
  'settings.motionHint': 'Выкл. отключает любую несущественную анимацию; Сдержанно делает появления короткими; Полно — самый насыщенный вариант.',
};
