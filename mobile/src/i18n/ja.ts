...
export const ja: Dict = {
  ...
  'settings.aboutBody': '騎士ひとりの遠征。こんな形では存在しなかった、自由でオープンソースな道具です。アカウントもテレメトリもなく、読めるものが自分の城壁の外へ出ることはありません。待つという選択肢がなかったので、夜と週末に心を込めて鍛えました。',
  'settings.accentReset': '既定',
  'settings.aboutCoffeeButton': 'コーヒーをおごる',
  'settings.aboutCoffee': 'KnightLoader は無料で、これからも無料です。寄付はプロジェクトを生かし、かかる費用をまかないます。ドメイン、サーバー、そして注ぎ込まれる夜の時間です。',
