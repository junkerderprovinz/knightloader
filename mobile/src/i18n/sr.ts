...
export const sr: Dict = {
  ...
  'connect.relayLink': 'Nije direktno dostupna? Povežite se preko releja',
  'relay.title': 'Povezivanje preko releja',
  'relay.hint':
    'Za instance do kojih se sa ove mreže uopšte ne može doći direktno. Svaka se sama povezuje na isti relej, kao i ova aplikacija. Unesite adresu i ključ releja onako kako su podešeni na instancama.',
  ...
  'relay.noInstances': 'Trenutno nijedna instanca nije povezana sa ovim relejem. Proverite ključ i da li radi bar jedna instanca.',
  'relay.tokenHint': 'Potreban samo ako je za tu instancu podešena lozinka.',
  'relay.saveButton': 'Sačuvaj vezu',
};
