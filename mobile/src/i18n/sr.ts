...
export const sr: Dict = {
  ...
  'settings.aboutBody': 'Један витез, један поход: слободни алати отвореног кода каквих није било. Никаквих налога, никакве телеметрије и ништа читљиво никада не напушта твоје зидине. Ковано вечерима и викендом са срцем, јер чекање није било опција.',
  'settings.accentReset': 'Подразумевано',
  'settings.aboutCoffeeButton': 'Части ме кафом',
  'settings.aboutCoffee': 'KnightLoader је бесплатан и такав остаје. Донација држи пројекат у животу и покрива оно што кошта: домен, сервер и вечери које у њега одлазе.',
