...
export const sr: Dict = {
  ...
  'downloads.startHeld': '{n} веза је одбијено и нису покренуте.',
  ...
  'captcha.open': 'Одговори',
  'captcha.waiting': 'Captcha за {host} чека одговор.',
  'captcha.empty': 'Ниједна captcha не чека.',
  'captcha.answerLabel': 'Одговор',
  'captcha.answerPlaceholder': 'Упиши оно што видиш…',
  'captcha.clickHint': 'Додирни сваку тачку коју слика тражи, па притисни Настави.',
  ...
  'captcha.widgetScoreHint': 'Не мораш ништа да додирујеш. Captcha услуга проверава овај телефон и сама предаје свој одговор.',
  'captcha.solve': 'Реши',
  'captcha.widgetUnavailable': 'Овaj изазов није било могуће учитати.',
  'captcha.widgetUnreachable': 'Телефон није могао да дође до инстанце ни до captcha услуге. Можда то блокира мрежни филтер. „Освежи“ покушава поново.',
  ...
  'captcha.unsolvableTurnstile': 'KnightLoader не може сам да прикаже Cloudflare Turnstile изазов, па на њега може да одговори само плаћени решавач подешен у подешавањима за Captcha на инстанци. „Откажи“ прескаче ову captcha.',
  ...
  'captcha.solverWaitingHint': 'Гледаш, па решавачи прво чекају твој одговор. Чим је апликација у позадини или истекне време, преузима први решавач у твом редоследу.',
