...
export const sr: Dict = {
  ...
  'settings.aboutBody': 'Написано увече и викендом, уз више кафе него што је разумно, јер је сваки други менаџер преузимања тражио два клика тамо где је био довољан један.',
  ...
  'settings.aboutGithub': 'На GitHub-у',
