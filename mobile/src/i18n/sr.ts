...
export const sr: Dict = {
  ...
  'settings.aboutBody': 'Поход у једном једином оклопу: слободни алати отвореног кода каквих није било. Никаквих налога, никакве телеметрије и ништа читљиво никада не напушта твоје зидине. Ковано вечерима и викендом са срцем, јер чекање није било опција.',
