...
export const it: Dict = {
  ...
  'settings.aboutBody': 'Un solo cavaliere, una crociata: strumenti liberi e open source che così non esistevano. Nessun account, nessuna telemetria, e niente di leggibile lascia mai le tue mura. Forgiato di sera e nei fine settimana con molto cuore, perché aspettare non era un\'opzione.',
  'settings.accentReset': 'Predefinito',
  'settings.aboutCoffeeButton': 'Offrimi un caffè',
  'settings.aboutCoffee': 'KnightLoader è gratuito e resta così. Una donazione tiene in vita il progetto e copre quello che costa: il dominio, il server e le sere che ci finiscono dentro.',
