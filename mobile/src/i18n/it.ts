...
export const it: Dict = {
  ...
  'downloads.startHeld': '{n} link sono stati rifiutati e non sono partiti.',
  ...
  'captcha.open': 'Rispondi',
  'captcha.waiting': 'Un captcha per {host} aspetta una risposta.',
  'captcha.empty': 'Nessun captcha in attesa.',
  'captcha.answerLabel': 'Risposta',
  'captcha.answerPlaceholder': 'Scrivi quello che vedi…',
  'captcha.clickHint': 'Tocca ogni punto che l’immagine chiede, poi premi Continua.',
  ...
  'captcha.widgetScoreHint': 'Non devi toccare niente. Il servizio captcha controlla questo telefono e consegna la sua risposta da solo.',
  'captcha.solve': 'Risolvi',
  'captcha.widgetUnavailable': 'Non è stato possibile caricare questa verifica.',
  'captcha.widgetUnreachable': 'Il telefono non è riuscito a raggiungere l’istanza o il servizio captcha. Forse un filtro di rete lo blocca. «Aggiorna» riprova.',
  ...
  'captcha.unsolvableTurnstile': 'KnightLoader non può mostrare da sé una verifica Cloudflare Turnstile, quindi può risponderle solo un risolutore a pagamento configurato nelle impostazioni Captcha dell’istanza. «Annulla» salta questo captcha.',
  ...
  'captcha.solverWaitingHint': 'Stai guardando, quindi i risolutori aspettano prima la tua risposta. Appena l’app passa in secondo piano o il tempo scade, subentra il primo risolutore nel tuo ordine.',
