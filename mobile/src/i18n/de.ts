...
export const de: Dict = {
  ...
  'downloads.startHeld': '{n} Link(s) wurden abgelehnt und nicht gestartet.',
  ...
  'captcha.solverWaitingHint': 'Du schaust zu, also warten die Löser erst auf deine Antwort. Sobald die App im Hintergrund ist oder die Zeit abläuft, übernimmt der erste Löser in deiner Reihenfolge.',
