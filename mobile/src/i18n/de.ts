...
export const de: Dict = {
  ...
  'settings.aboutBody': 'An Abenden und Wochenenden geschrieben, von einer Person, weil jeder andere Downloadmanager zwei Klicks wollte, wo einer gereicht hätte.',
