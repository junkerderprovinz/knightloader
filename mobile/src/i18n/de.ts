...
export const de: Dict = {
  ...
  'settings.aboutBody': 'In Abenden und Wochenenden geschrieben, mit mehr Kaffee als ratsam ist, weil jeder andere Downloadmanager zwei Klicks wollte, wo einer gereicht hätte.',
  ...
  'settings.aboutGithub': 'Auf GitHub',
