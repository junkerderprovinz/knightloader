...
export const de: Dict = {
  ...
  'settings.aboutBody': 'Ein einzelner Ritter, ein Feldzug: freie, quelloffene Werkzeuge, die es so nicht gab. Keine Konten, keine Telemetrie, und nichts Lesbares verlässt deine eigenen Mauern. An Abenden und Wochenenden mit viel Herzblut geschmiedet, weil Warten keine Option war.',
  'settings.accentReset': 'Standard',
  'settings.aboutCoffeeButton': 'Kaffee spendieren',
  'settings.aboutCoffee': 'KnightLoader ist kostenlos und bleibt es. Eine Spende hält das Projekt am Leben und deckt, was es kostet: Domain, Server und die Abende, an denen weitergebaut wird.',
  ...
  'settings.motionHint': 'Aus schaltet jede nicht notwendige Animation ab; Dezent hält Einblendungen kurz; Wild ist die reichhaltigste Erfahrung.',
};
