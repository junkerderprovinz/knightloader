...
export const no: Dict = {
  ...
  'settings.aboutBody': 'Skrevet på kvelder og i helger, på mer kaffe enn det som er tilrådelig, fordi alle andre nedlastingsprogrammer ville ha to klikk der ett holdt.',
