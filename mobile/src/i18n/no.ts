...
export const no: Dict = {
  ...
  'downloads.startHeld': '{n} lenke(r) ble avvist og ikke startet.',
  ...
  'captcha.clickHint': 'Trykk på hvert punkt bildet ber om, og velg deretter Fortsett.',
  ...
  'captcha.widgetScoreHint': 'Du trenger ikke trykke på noe. Captcha-tjenesten sjekker denne telefonen og leverer svaret sitt av seg selv.',
  'captcha.solve': 'Løs',
  'captcha.widgetUnavailable': 'Denne utfordringen kunne ikke lastes.',
  'captcha.widgetUnreachable': 'Telefonen nådde ikke instansen eller captcha-tjenesten. Kanskje et nettverksfilter blokkerer forbindelsen. Oppdater prøver igjen.',
  ...
  'captcha.unsolvableTurnstile': 'KnightLoader kan ikke vise en Cloudflare Turnstile-utfordring selv, så bare en betalt løser som er satt opp i captcha-innstillingene til instansen, kan svare på den. Avbryt hopper over denne captchaen.',
  ...
  'captcha.solverWaitingHint': 'Du ser på, så løserne venter først på svaret ditt. Så snart appen er i bakgrunnen eller tiden går ut, tar den første løseren i rekkefølgen din over.',
