...
export const no: Dict = {
  ...
  'settings.aboutBody': 'Én ridder, ett korstog: frie verktøy med åpen kildekode som ikke fantes slik. Ingen kontoer, ingen telemetri, og ingenting lesbart forlater noen gang dine egne murer. Smidd på kvelder og i helger med mye hjerte, fordi det ikke var et alternativ å vente.',
  'settings.accentReset': 'Standard',
  'settings.aboutCoffeeButton': 'Spander en kaffe',
  'settings.aboutCoffee': 'KnightLoader er gratis og forblir det. En donasjon holder prosjektet i live og dekker det det koster: domenet, serveren og kveldene som går med.',
  ...
  'settings.aboutMail': 'Send en e-post',
  ...
  'settings.motionHint': 'Av slår av all ikke-essensiell animasjon; Diskret holder inntredener korte; Vill er den rikeste opplevelsen.',
};
