...
export const th: Dict = {
  ...
  'downloads.stop': 'หยุด',
  'downloads.startHeld': 'ลิงก์ {n} รายการถูกปฏิเสธและไม่ได้เริ่ม',
  ...
  'captcha.solverWaitingHint': 'คุณกำลังดูอยู่ ตัวแก้จึงรอคำตอบของคุณก่อน เมื่อแอปอยู่เบื้องหลังหรือหมดเวลา ตัวแก้ตัวแรกตามลำดับของคุณจะรับช่วงต่อ',
