...
export const th: Dict = {
  ...
  'settings.aboutBody': 'อัศวินคนเดียว การเดินทัพครั้งเดียว เครื่องมือเสรีโอเพนซอร์สที่ไม่เคยมีในแบบนี้ ไม่มีบัญชี ไม่มีการเก็บข้อมูลการใช้งาน และไม่มีสิ่งใดที่อ่านได้ออกไปพ้นกำแพงของคุณ ตีขึ้นในยามเย็นและวันหยุดสุดสัปดาห์ด้วยใจ เพราะการรอไม่ใช่ทางเลือก',
  'settings.accentReset': 'ค่าเริ่มต้น',
  'settings.aboutCoffeeButton': 'เลี้ยงกาแฟ',
  'settings.aboutCoffee': 'KnightLoader ฟรีและจะฟรีต่อไป การบริจาคช่วยให้โครงการอยู่รอดและครอบคลุมค่าใช้จ่าย ทั้งโดเมน เซิร์ฟเวอร์ และค่ำคืนที่ทุ่มลงไป',
  ...
  'settings.motion.wild': 'เต็มรูปแบบ',
  ...
  'settings.motionHint': 'ปิด จะปิดแอนิเมชันที่ไม่จำเป็นทั้งหมด นุ่มนวล จะทำให้การปรากฏสั้นลง เต็มรูปแบบ คือประสบการณ์ที่สมบูรณ์ที่สุด',
};
