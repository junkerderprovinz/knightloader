...
export const th: Dict = {
  ...
  'connect.qrRelayOnly': 'โค้ดนี้ใช้เชื่อมอินสแตนซ์ KnightLoader สองตัวเข้าด้วยกันผ่านรีเลย์ จึงใช้ที่นี่ไม่ได้ - แอปนี้เป็นไคลเอนต์ ไม่ใช่อินสแตนซ์ ให้ใช้ "เข้าถึงโดยตรงไม่ได้ใช่ไหม เชื่อมต่อผ่านรีเลย์" ด้านล่าง พร้อมที่อยู่และคีย์ของรีเลย์',
  ...
  'settings.rainbowOnFromInstance': 'เปิด ตั้งไว้ที่อินสแตนซ์',
  'settings.rainbowOff': 'ปิด',
  ...
  'settings.problemsReport': 'แจ้งปัญหา',
  ...
  'connect.relayLink': 'เข้าถึงโดยตรงไม่ได้ใช่ไหม เชื่อมต่อผ่านรีเลย์',
  'relay.title': 'เชื่อมต่อผ่านรีเลย์',
  'relay.hint':
    'สำหรับอินสแตนซ์ที่ไม่มีอะไรในเครือข่ายนี้เข้าถึงได้โดยตรง แต่ละอินสแตนซ์จะเชื่อมต่อออกไปยังรีเลย์เดียวกัน และแอปนี้ก็เช่นกัน กรอกที่อยู่และคีย์ของรีเลย์ตามที่ตั้งไว้ในอินสแตนซ์ของคุณ',
  'relay.urlLabel': 'ที่อยู่รีเลย์',
  'relay.keyLabel': 'คีย์รีเลย์',
  'relay.keyPlaceholder': 'คีย์ที่อินสแตนซ์ของคุณใช้ร่วมกัน',
  'relay.searchButton': 'ค้นหาอินสแตนซ์',
  'relay.errorMissing': 'กรอกที่อยู่รีเลย์และคีย์',
  'relay.errorBadUrl': 'นี่ไม่ใช่ที่อยู่รีเลย์',
  'relay.errorKeyShort': 'คีย์รีเลย์มีความยาวอย่างน้อย {n} ตัวอักษร',
  'relay.instancesTitle': 'บนรีเลย์นี้',
  'relay.noInstances': 'ตอนนี้ยังไม่มีอินสแตนซ์ใดเชื่อมต่อกับรีเลย์นี้ ตรวจสอบคีย์ และดูว่ามีอินสแตนซ์ทำงานอยู่อย่างน้อยหนึ่งตัวหรือไม่',
  'relay.tokenHint': 'จำเป็นเฉพาะเมื่ออินสแตนซ์นั้นตั้งรหัสผ่านไว้',
  'relay.saveButton': 'บันทึกการเชื่อมต่อ',
};
