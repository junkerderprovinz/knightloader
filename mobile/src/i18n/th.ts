...
export const th: Dict = {
  ...
  'settings.aboutBody': 'โปรแกรมจัดการดาวน์โหลดที่คุณโฮสต์เอง หน้าตาสะอาด เป็นทางเลือกแทน JDownloader เอนจิน เอพีไอ และหน้าจอ อยู่ในโปรแกรมเดียว ไม่มีอะไรต้องติดตั้งเพิ่มข้าง ๆ เขียนขึ้นในยามค่ำและวันหยุดสุดสัปดาห์ เพราะตัวอื่นล้วนขอสองคลิกในที่ที่คลิกเดียวก็พอ',
  'settings.accentReset': 'ค่าเริ่มต้น',
  'settings.aboutCoffeeButton': 'เลี้ยงกาแฟ',
  'settings.aboutCoffee': 'ชอบ KnightLoader ไหม กาแฟสักแก้วจะทำให้วันของผมดีขึ้น',
