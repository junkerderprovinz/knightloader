...
export const et: Dict = {
  ...
  'settings.aboutBody': 'Kirjutatud õhtuti ja nädalavahetustel, rohkema kohviga kui mõistlik, sest iga teine allalaadimishaldur tahtis kahte klõpsu seal, kus piisas ühest.',
