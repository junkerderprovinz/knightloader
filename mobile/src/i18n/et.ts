...
export const et: Dict = {
  ...
  'settings.aboutBody': 'Üks rüütel, üks sõjaretk: vabad, avatud lähtekoodiga tööriistad, mida sellisel kujul polnud. Ei ühtki kontot, ei mingit telemeetriat ja miski loetav ei lahku kunagi sinu enda müüride vahelt. Sepistatud õhtuti ja nädalavahetustel südamega, sest ootamine polnud valik.',
  'settings.accentReset': 'Vaikimisi',
  'settings.aboutCoffeeButton': 'Osta mulle kohv',
  'settings.aboutCoffee': 'KnightLoader on tasuta ja jääb selleks. Annetus hoiab projekti elus ja katab selle kulud: domeeni, serveri ja õhtud, mis sellesse lähevad.',
  ...
  'settings.aboutMail': 'Saada e-kiri',
  ...
  'settings.motionHint': 'Väljas lülitab välja iga mittevajaliku animatsiooni; Peen hoiab sisenemised lühikesed; Metsik on kõige rikkalikum kogemus.',
};
