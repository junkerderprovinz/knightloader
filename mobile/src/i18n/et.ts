...
export const et: Dict = {
  ...
  'instance.captchas': '{n} captchat ootab praegu',
  'instance.captchasOne': '1 captcha ootab praegu',
  'downloads.start': 'Alusta',
  'downloads.stop': 'Peata',
  'downloads.startHeld': '{n} linki lükati tagasi ega käivitunud.',
  ...
  'captcha.empty': 'Ükski captcha ei oota.',
  'captcha.answerLabel': 'Vastus',
  'captcha.answerPlaceholder': 'Kirjuta, mida näed…',
  'captcha.clickHint': 'Puuduta iga punkti, mida pilt küsib, seejärel vajuta Jätka.',
  ...
  'captcha.widgetScoreHint': 'Sul pole vaja midagi puudutada. Captcha-teenus kontrollib seda telefoni ja annab oma vastuse ise üle.',
  'captcha.solve': 'Lahenda',
  'captcha.widgetUnavailable': 'Seda ülesannet ei õnnestunud laadida.',
  'captcha.widgetUnreachable': 'Telefon ei jõudnud eksemplari ega captcha-teenuseni. Võib-olla blokeerib ühendust võrgufilter. Värskenda proovib uuesti.',
  ...
  'captcha.unsolvableTurnstile': 'KnightLoader ei suuda Cloudflare Turnstile\'i ülesannet ise näidata, seega saab sellele vastata ainult tasuline lahendaja, mis on seadistatud eksemplari captcha seadetes. Loobu jätab selle captcha vahele.',
  ...
  'captcha.solverWaitingHint': 'Sa vaatad, seega ootavad lahendajad esmalt sinu vastust. Kui rakendus on taustal või aeg saab otsa, võtab üle sinu järjekorra esimene lahendaja.',
